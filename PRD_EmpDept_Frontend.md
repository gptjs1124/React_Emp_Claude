...
- [x] 새로고침(F5) 시 현재 페이지가 유지된다 → `npm run build` 성공
...
**✅ Phase 8 완료 기준:**
- [x] `/departments` 접속 시 3개의 부서 카드가 보인다
- [x] 삭제 버튼 클릭 후 confirm → 카드가 사라진다
- [x] 새로고침 후 삭제된 항목이 복원된다 (백엔드가 in-memory 방식이므로 정상)
- [x] `npm run build` 성공
...
**✅ Phase 9 완료 기준:**
- [x] `/departments/new`에서 폼 작성 후 등록 → 목록 페이지로 이동, 새 항목이 보인다
- [x] 목록에서 수정 버튼 클릭 → 폼에 기존 데이터가 채워진다
- [x] 수정 후 저장 → 목록에서 변경된 내용이 반영된다
- [x] `npm run build` 성공
...
**✅ Phase 10 완료 기준:**
- [x] `/employees` 접속 시 3명의 직원 카드가 보인다
- [x] 각 카드에 부서 이름 뱃지가 표시된다
- [x] 삭제가 정상 동작한다
- [x] `npm run build` 성공
...
**✅ Phase 11 완료 기준:**
- [x] 직원 등록 폼에서 부서 드롭다운이 정상 출력된다
- [x] 등록 후 직원 목록으로 이동하고 새 직원이 보인다
- [x] 수정 시 기존 정보가 폼에 채워진다
- [x] `npm run build` 성공
...
**✅ Phase 12 완료 기준:**
- [x] 홈 화면에 부서 수(3)와 직원 수(3)가 카드로 표시된다
- [x] 카드 클릭 시 해당 목록 페이지로 이동한다
- [x] `npm run build` 성공
...
- [x] 부서 목록에서 4개 카드 확인 (HR, Marketing, Sales, IT)
- [x] 새 부서 등록 (Finance & Accounting) → 목록에 추가됨
- [x] 부서 수정 (Finance → Finance & Accounting) → 변경된 이름 확인
- [x] 부서 삭제 → 목록에서 제거됨

**직원 관리:**
- [x] 직원 목록에서 4명 + 부서 뱃지 확인
- [x] 새 직원 등록 (James Wilson / IT, 부서 선택 포함) → 목록 추가
- [x] 직원 수정 (IT → Sales) → 변경 내용 반영
- [x] 직원 삭제 → 목록에서 제거
